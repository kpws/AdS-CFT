...
\section{Outlook}
A much more thorough comparison with experimental results could be made. Formula \eqref{muTdep} could for example be investigated. The conductivity can also be investigate much more thoroughly. This has though already been done, e.g.~\cite{hartnoll8}, but it would be interesting to repeat their calculations.
\begin{appendices}
